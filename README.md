...
# Tools & Workflow
This project was executed using a structured 3-phase workflow across Excel, MYSQL, and Power BI — each tool serving a specific purpose in the data analytics lifecycle.
...
### Tasks Completed:
- Imported the cleaned Excel data into a MYSQL database.
...
Before importing into MYSQL, the dataset was cleaned and structured in Excel to ensure consistency and compatibility. The following preparation steps were taken:
...
After importing the cleaned dataset into MYSQL, several SQL queries were executed to explore and analyse churn behavior across various dimensions. Below are the key business questions addressed along with how they were solved:
...
## Trend Identified
- Customers with month-to-month contracts leave the most.
- Fiber internet users have higher churn (possible pricing or service issues).
- Customers using manual payments (like electronic check) churn more.
- New customers (0–6 months) are at the highest risk.
- Customers with extra services (security, support) tend to stay longer.
- Senior citizens and single customers churn slightly more.

# Recommendations
- Encourage customers to switch to long-term contracts.
- Promote automatic payments to reduce churn.
- Focus on new customers with better onboarding and support.
- Offer service bundles to increase customer retention.
- Target high-risk groups with special offers or campaigns.
- Investigate fiber service issues (pricing or quality).
